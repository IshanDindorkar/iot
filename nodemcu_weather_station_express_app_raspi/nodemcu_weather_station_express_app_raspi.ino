...
void loop() {
    ...
    if((WiFiMulti.run() == WL_CONNECTED)) {
        ...
        char url[256];
        // When app runs on Raspberry Pi, use this URL
        // sprintf (url, "http://192.168.1.13:3000/log/%d/%d/%d", (int)t, (int)h, (int)ldr);

        // When sensor data is pushed to app installed on Heroku, use this URL
        sprintf (url, "http://weather-station-iot-2021.herokuapp.com/log/%d/%d/%d", (int)t, (int)h, (int)ldr);
